...
## --------------------------------------------------------
		...
		#
	{
		...
		$this->fileExtension = lower(strrchr($fileName, '.'));
...
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/
		...
		#
	{
		...
		$cropPos = 'm';
		if (is_array($option) && lower($option[0]) == 'crop')
		{
...
## --------------------------------------------------------
		...
		#
	{
		if (is_array($option))
		{
			if (lower($option[0]) == 'crop' && count($option) == 2)
			{
				return 'crop';
			}
			else
...
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/
		...
		#
	{
		...
		if (lower(strrchr($watermarkImage, '.')) == '.png')
		{
